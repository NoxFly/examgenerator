...
document.querySelectorAll('.select').forEach($select => prepareSelect($select));
document.querySelectorAll('.search-bar').forEach($searchbar => prepareSearchBar($searchbar));
document.querySelectorAll('.switch-1').forEach($switch => prepareSwitch($switch));
